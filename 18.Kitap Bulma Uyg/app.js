let kitap1 = { isim: "Her seyi düsünme ", yazar: "Anna Bogel", fiyat: 25,raf:'1.5.RAF' };
let kitap2 = {
  isim: "Hicbir karsilasma tesadüf degildir",
  yazar: "Hakal Mengüc",
  fiyat: 55,raf:'2.3.RAF'
};
let kitap3 = { isim: "Insan ne ile yasar", yazar: "Tolstoy", fiyat: 34,raf:'3.4.RAF' };
let kitap4 = {
  isim: "Zafer Sizlanarak kazanilmaz",
  yazar: "Haluk Tatar",
  fiyat: 45,raf:'4.1.RAF'
};
let kitap5 = {
  isim: "Seker Portakali",
  yazar: "Meu Pé de Laranja Lima",
  fiyat: 22,raf:'5.3.RAF'
};
